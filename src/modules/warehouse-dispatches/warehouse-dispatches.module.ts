...
import { WarehouseDispatchPublicController } from './warehouse-dispatch-public.controller';
...
@Module({
  ...
  controllers: [WarehouseDispatchesController, WarehouseDispatchPublicController],
