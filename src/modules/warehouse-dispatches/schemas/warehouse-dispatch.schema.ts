...
export class WarehouseDispatch {
  ...
  /** Xarid qabulida tasdiqlangan nomeklatura raqami */
  @Prop({ trim: true })
  confirmedNomenclatureCode?: string;
...
WarehouseDispatchSchema.index(
  { purchaseRequestId: 1, purchaseBatchId: 1 },
  {
    unique: true,
    partialFilterExpression: { purchaseBatchId: { $type: 'string' } },
  },
);
